...
function propertyCard(name, rent, oneHouse, twoHouses, threeHouses, fourHouses, hotel, housePrice,
    ...
    return `<div id="card" class="border border-dark" style="width:220px; margin-left: auto; margin-right: auto; margin-top: 10px">
        <div id="box-title" class = "border border-dark" style="background-` + color_hex[color] +
        ...
        <div id="hypotheque" style="font-size: 12px; margin-top: 6px; margin-bottom: 6px">
...
export function updateModalCardProperty(name, rent, oneHouse, twoHouses, threeHouses, fourHouses, hotel, housePrice, hypotheque, color) {
    $("#card").replaceWith(propertyCard(name, rent, oneHouse, twoHouses, threeHouses, fourHouses, hotel, housePrice, hypotheque, color));
}

export function updateModalCardStation(name) {
    $("#card").replaceWith(stationCard(name));
}

export function updateModalCardCompany(name) {
